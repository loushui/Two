package cn.com.loushui.mylibrary.view;
...
import cn.com.loushui.mylibrary.R;
...
public class ProgressWheel extends View {
     ...
     * **********
     */
    private int circleRadius = 28;//圆圈的半径
    private int barWidth = 4;//滑块宽度
    private int rimWidth = 4;//圆环宽度

    private final int barLength = 16;
    private final int barMaxLength = 270;//滑块最大长度

    private boolean fillRadius = false;//是否占满区域

    private double timeStartGrowing = 0;
    private double barSpinCycleTime = 460;//旋转周期(滑块尾部)
    private float barExtraLength = 0;//
    private boolean barGrowingFromFront = true;

    private long pausedTimeWithoutGrowing = 0;//暂停增长的时间
    private final long pauseGrowingTime = 200;//时间间隔

    //Colors (with defaults)
    private int barColor = 0xAA000000;//滑块颜色
    ...
    //Rectangles
    private RectF circleBounds = new RectF();//控件区域
    ...
    private boolean linearProgress;//是否为线型进度

    private float mProgress = 0.0f;
    private float mTargetProgress = 0.0f;
    private boolean isSpinning = false;//是否循环
    ...
    /**
     * 代替onAttachedToWindow，来设定控件和画笔属性
     */
    @Override
    ...
    private void setupPaints() {
        ...
        barPaint.setStyle(Style.STROKE);//空心圆环
        barPaint.setStrokeWidth(barWidth);//圆环宽度
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.ProgressWheel_pw_circleRadius, circleRadius);
        ...
        float baseSpinSpeed = a.getFloat(R.styleable.ProgressWheel_pw_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.ProgressWheel_pw_barSpinCycleTime, (int) barSpinCycleTime);
